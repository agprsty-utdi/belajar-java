...
public class Latihan {
    ...
    { 
        ...
        Scanner masukan = new Scanner(System.in);
        System.out.print("Masukkan kata kunci jekel (l/p) : ");
        kataKunci = masukan.next();
        
        //bagian mencari data satu persatu urut dari larik terdepan
        for (int i=0; i<= N-1; i++)
        {
            char myCharFromKataKunci = kataKunci.charAt(0);
            if (biodataMahasiswa[i].jekel == myCharFromKataKunci){ 
                System.out.print (i +".");
    ...
    { 
        ...
        mencariData(biodataMahasiswa); // Mencari data berdasarkan keyword jekel l/p
    }
}
