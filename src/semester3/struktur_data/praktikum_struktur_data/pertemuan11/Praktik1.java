package semester3.struktur_data.praktikum_struktur_data.pertemuan11;
...
public class Praktik1 {
    ...
    public static void cetakSenaraiMaju() {
        System.out.println("------------- Cetak Seranai Maju ----------------");
        if (awal==null) // jika senarai masih kosong
    ...
    public static void cetakSenaraiMundur() {
        System.out.println("------------- Cetak Seranai Mundur ----------------");
        if (awal==null) // jika senarai masih kosong
            System.out.print("....MAAF SENARAI KOSONG....");
        else { // jika senarai tidak kosong
            System.out.println("---------------------------------------------------");
