...
public class Praktik4 {
    ...
    //------------------------------------------------------
    public static void mengurutkanDescanding(formatBiodata biodataMahasiswa[])
    {
    ...
    { 
        ...
        mengurutkanDescanding(biodataMahasiswa); //Fungsi untuk Mengurutkan Data (BubbleSort) 
        tampilkanData(biodataMahasiswa);
    }
}
