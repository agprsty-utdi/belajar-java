...
public class Praktik2 {
    ...
    //--------------------------------------------------
    public static void tambahDataDiTengah(formatBiodata biodataMahasiswa[]) //fungsi tambah data di tengah
    {
        System.out.println("Tambahkan Data di Tengah!");
    ...
    { 
        ...
        tambahDataDiTengah(biodataMahasiswa);//Lakukan pemanggilan fungsi tambah data (tengah)
        tampilkanData(biodataMahasiswa);
    }
}
