...
public class Praktik3 {
    ...
    //--------------------------------------------------
    public static void tambahDataDiBelakang(formatBiodata biodataMahasiswa[]) //fungsi tambah data di belakang
    {
        System.out.println("Tambahkan Data di Belakang!");
    ...
    { 
        ...
        tambahDataDiBelakang(biodataMahasiswa);//Lakukan pemanggilan fungsi tambah data (belakang)
        tampilkanData(biodataMahasiswa);
    }
}
